...
We provide evaluation servers for the Ball Action Anticipation task. The evaluation server handles predictions for the open [**test**](https://www.codabench.org/competitions/10861/) sets and the segregated [**challenge**](https://www.codabench.org/competitions/10867/) sets.

Winners will tentatively be announced at the CVSports Workshop at CVPR 2026.
...
## Who can participate / How to participate?
 ...
 - A particpant can only use the video stream as input (visual and/or audio) to solve the Ball Action Anticipation task.
...
## How to win / What is the prize?
 ...
 - The metric taken into consideration is the **Average of mAP@1, mAP@2, mAP@3, mAP@4, mAP@5 and mAP@Infty on the Ball Action Anticipation task**.
 - The deadline to submit your results is April 24th 2026.
...
Note that these dates are tentative and subject to changes if necessary.
 ...
 - **October 6:** Open evaluation server on the (Open) Test set.
 - **October 6:** Open evaluation server on the (Seggregated) Challenge set.
...
For any further doubt or concern, please raise an issue in the repository, or contact us directly on [Discord](https://discord.gg/SM8uHj9mkP).